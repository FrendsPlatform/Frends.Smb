...
public class ErrorHandlerTest
{
    ...
    public void Should_Throw_Error_When_ThrowErrorOnFailure_Is_True()
    {
        var ex = Assert.Throws<Exception>(() =>
           Smb.DeleteDirectory(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None));
    ...
    public void Should_Return_Failed_Result_When_ThrowErrorOnFailure_Is_False()
    {
        ...
        var result = Smb.DeleteDirectory(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
    ...
    public void Should_Use_Custom_ErrorMessageOnFailure()
    {
        ...
        var ex = Assert.Throws<Exception>(() =>
            Smb.DeleteDirectory(DefaultInput(), DefaultConnection(), options, CancellationToken.None));
        Assert.That(ex, Is.Not.Null);
