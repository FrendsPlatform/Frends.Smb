...
public class KerberosAuthenticationTests
{
    ...
    [Test]
    public void DeleteDirector_Kerberos_Success()
    {
    ...
    [Test]
    public void DeleteDirector_KerberosTicketCache_Success()
    {
        var dirPath = Path.Combine("oldDir", "subDir");
    ...
    [Test]
    public void DeleteDirector_KerberosTicketCache_MissingCacheFile_Fails()
    {
        var dirPath = Path.Combine("oldDir", "subDir");
        Directory.CreateDirectory(Path.Combine(testFilesPath, dirPath));
