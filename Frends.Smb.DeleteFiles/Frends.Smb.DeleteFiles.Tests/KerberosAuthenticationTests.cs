...
public class KerberosAuthenticationTests
{
    ...
    [Test]
    public async Task DeleteFiles_Kerberos_Success()
    {
    ...
    [Test]
    public async Task DeleteFiles_KerberosTicketCache_Success()
    {
        await CreateTestFileAsync("single-target.txt", "Delete me!");
    ...
    [Test]
    public async Task DeleteFiles_KerberosTicketCache_MissingCacheFile_Fails()
    {
        await CreateTestFileAsync("single-target.txt", "Delete me!");
    ...
    [Test]
    public async Task DeleteFiles_Kerberos_WrongPassword_Fails()
    {
        await CreateTestFileAsync("single-target.txt", "Delete me!");
