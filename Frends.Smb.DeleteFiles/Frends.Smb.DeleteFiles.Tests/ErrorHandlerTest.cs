...
public class ErrorHandlerTest
{
    ...
    public void Should_Throw_Error_When_ThrowErrorOnFailure_Is_True()
    {
        var ex = Assert.ThrowsAsync<System.ArgumentException>(async () =>
                await Smb.DeleteFiles(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None));
    ...
    public async Task Should_Return_Failed_Result_When_ThrowErrorOnFailure_Is_FalseAsync()
    {
        ...
        var result = await Smb.DeleteFiles(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
    ...
    public void Should_Use_Custom_ErrorMessageOnFailure()
    {
        ...
        var ex = Assert.ThrowsAsync<System.Exception>(async () =>
           await Smb.DeleteFiles(DefaultInput(), DefaultConnection(), options, CancellationToken.None));
        Assert.That(ex, Is.Not.Null);
