...
public class KerberosAuthenticationTests
{
    ...
    public async Task GlobalSetup()
    {
        ...
        await File.WriteAllTextAsync(Path.Combine(testFilesPath, "test-utf8.txt"), "Hello World");
    ...
    [Test]
    public async Task ReadFile_Kerberos_Success()
    {
        input = new Input
        {
            Path = @"test-utf8.txt",
    ...
    [Test]
    public async Task ReadFile_KerberosTicketCache_Success()
    {
        input = new Input
        {
            Path = @"test-utf8.txt",
    ...
    [Test]
    public async Task ReadFile_KerberosTicketCache_MissingCacheFile_Fails()
    {
        input = new Input
        {
            Path = @"test-utf8.txt",
    ...
    [Test]
    public async Task ReadFile_Kerberos_WrongPassword_Fails()
    {
