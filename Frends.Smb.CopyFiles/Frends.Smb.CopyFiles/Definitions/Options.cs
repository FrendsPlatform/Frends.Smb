...
public class Options
{
    ...
    /// <summary>
    /// When enabled, the task continues copying remaining files even if individual file operations fail.
    /// Successfully copied files are returned in Files with Success = true. Failed files
